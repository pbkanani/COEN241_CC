...
def handle(req):
    ...
    inp = response["actions"][0]["value"]
    selected = "You selected Of course!" if inp == 'recommend' else "You selected most Definitely!"
    data = {
        "attachments": [
            {
                ...
                "color": "#36a64f",
                "pretext": selected + "Ahh yeah! Great choice, COEN 241 is absolutely amazing!",
                "author_name": "Poonam",
                "author_link": "https://github.com/pbkanani/COEN241_CC",
                "author_icon": "https://avatars.githubusercontent.com/u/92608195?s=400&v=4",
                "title": "COEN 241",
